...
#role :web, "kpi.smartdate.com"
#role :app, "kpi.smartdate.com"
# role :db,  "db01.example.com", :primary => true
# role :db,  "db02.example.com", "db03.example.com"
server "kpi.smartdate.com", :app, :web

# =============================================================================
# OPTIONAL VARIABLES
# =============================================================================
set :deploy_to, "/var/www/app-kpi/current" # defaults to "/u/apps/#{application}"
set :scm, "git"
