...
class RTSalesByProvider extends RBlockRT {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
          SELECT  CONCAT(payment_status, ' - ', payment_provider) as provider, SUM(total_amount) AS total_amount FROM (
       ...
       ORDER BY provider"
        ...
        $this->setName("Total €[[Total revenue per provider - Note: non euro currencies are not converted]]");
    }
