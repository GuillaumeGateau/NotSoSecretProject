...
class RTUnlockHotseat extends DBlockRT {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        WHERE fpe.dimension_product_id IN (6) AND dt.id = CAST(CURDATE() AS UNSIGNED) ".
            $whereFilters.
            "GROUP BY dt.id
            ORDER BY dt.id DESC"
        ;

        $this->setName("Hotseat Unlocks[[Hotseat Unlock - Total number of Hotseat unlocks]]");
    }
