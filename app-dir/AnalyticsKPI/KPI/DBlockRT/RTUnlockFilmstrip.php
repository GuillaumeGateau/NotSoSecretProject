...
class RTUnlockFilmstrip extends DBlockRT {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        WHERE fpe.dimension_product_id IN (3) AND dt.id = CAST(CURDATE() AS UNSIGNED) ".
            $whereFilters.
            "GROUP BY dt.id
            ORDER BY dt.id DESC"
        ;

        $this->setName("Filmstrip Unlocks[[Filmstrip Unlock - Total number of Filmstrip unlocks]]");
    }
