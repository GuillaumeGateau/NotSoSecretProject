...
class RTUnlockSmartguess extends DBlockRT {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        WHERE fpe.dimension_product_id IN (5) AND dt.id = CAST(CURDATE() AS UNSIGNED) ".
            $whereFilters.
            "GROUP BY dt.id
            ORDER BY dt.id DESC"
        ;

        $this->setName("Smartguess Unlocks[[Smartguess Unlock - Total number of Smartguess unlocks]]");
    }
