...
class RTPerSourceCountries extends DBlockRTPerSource {
    ...
    function __construct() {
        ...
        $this->qu1 = "
            SELECT IF(source='(direct)','UNKNOWN',IF(source IS NULL,'UNKNOWN',source)) as src, country_code, SUM(num_of_registrations) FROM fact_registrations_events AS f
