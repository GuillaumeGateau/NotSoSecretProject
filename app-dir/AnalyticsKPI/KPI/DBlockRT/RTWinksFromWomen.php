...
class RTWinksFromWomen extends DBlockRT {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        SELECT dt.id, SUM(fua.num_of_winks) 
            ...
            ON dd.id = fua.dimension_demographics_id
                WHERE dd.gender = \"FEMALE\" AND dt.id = CAST(CURDATE() AS UNSIGNED) ".
            $whereFilters.
            "GROUP BY dt.id
            ORDER BY dt.id DESC"
        ;

        $this->setName("Winks from Women[[Winks from Women - Total number of winks sent by women]]");
    }
