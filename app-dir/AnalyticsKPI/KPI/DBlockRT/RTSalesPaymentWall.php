...
class RTSalesPaymentWall extends DBlockRT {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            AND dimension_payment_method_id=207 ".
            $whereFilters.
            "GROUP BY dt.id
            ORDER BY dt.id DESC"
        ;

        $this->setName("€ P.Wall[[PaymentWall Sales - Successful payments through PaymentWall]]");
    }
