...
class PerDayPayPalFOSales extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("Paypal €FO[[Paypal FO sales - First Order revenue processed by Paypal]]");
        $this->setGraphName("PayPal FO Sales");
        $this->setGraphVar("fo_ppal");
        $this->setGraphLabel("Paypal €FO");
    }
