...
class MarketPerAgeRegsFemaleDisabled extends DBlockMarketPerAge {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            SELECT
                CASE
                    ...
                    WHEN age>50 THEN '51+'
                END AS Age
            , SUM(num_of_registrations_disabled) AS regs FROM fact_registrations AS f
        ...
        $this->setName("Fem. Disabled[[Fem. Disabled - Number of female registrations that were disabled]]");
    }
