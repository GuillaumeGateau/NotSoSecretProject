...
class PTEST_PerDayFO6MoPlanTotal extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE dst.id=1 AND dpt.id=180 AND dl.id IN (22, 74) AND dd.age >=40
        ...
        $this->setName("#6MO TTL[[6-Month plans - Number of 6-Month plans]]");
        $this->setGraphName("6MO plans");
        $this->setGraphVar("fo_6mo");
        $this->setGraphLabel("#6MO TTL");
    }
