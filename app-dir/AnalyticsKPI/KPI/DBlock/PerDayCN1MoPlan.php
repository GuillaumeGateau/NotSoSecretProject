...
class PerDayCN1MoPlan extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("#CN 1MO[[1-month cancellations - Number of cancellations of 1-month plans]]");
        $this->setGraphName("1MO plans cancellations");
        $this->setGraphVar("cn_1mo");
        $this->setGraphLabel("#CN 1MO");
