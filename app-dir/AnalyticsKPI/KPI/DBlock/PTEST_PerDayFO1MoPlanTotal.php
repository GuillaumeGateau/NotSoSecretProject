...
class PTEST_PerDayFO1MoPlanTotal extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE dst.id=1 AND dpt.id=30 AND dl.id IN (22, 74) AND dd.age >=40
        ...
        $this->setName("#1MO TTL[[1-Month plans - Number of 1-Month plans]]");
        $this->setGraphName("1MO plans");
        $this->setGraphVar("fo_1mo");
        $this->setGraphLabel("#1MO TTL");
    }
