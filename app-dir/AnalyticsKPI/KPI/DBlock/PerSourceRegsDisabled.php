...
class PerSourceRegsDisabled extends DBlockPerSource{

    function __construct() {
        parent::__construct();

        $this->qu1 = "
            SELECT IF(source='(direct)','UNKNOWN',IF(source IS NULL,'UNKNOWN',source)) as src, SUM(num_of_registrations_disabled) FROM fact_registrations AS fr
        ...
        $this->setName("Disabled[[Regs. disabled - Number of registrations where the profile was disabled]]");
    }
