...
class PerDayPayPalSales extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("€ PayPal[[Paypal Sales - Successful payments processed through Paypal]]");
        $this->setGraphName("PayPal Sales");
        $this->setGraphVar("ppal_sal");
        $this->setGraphLabel("€ Paypal");
    }
