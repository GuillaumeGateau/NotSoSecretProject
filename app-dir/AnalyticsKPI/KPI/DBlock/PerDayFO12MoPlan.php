...
class PerDayFO12MoPlan extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("#12MO[[12-Month plans - Number of 12-Month plans]]");
        $this->setGraphName("12MO plans");
        $this->setGraphVar("fo_12mo");
        $this->setGraphLabel("#12MO");
    }
