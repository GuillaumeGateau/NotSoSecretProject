...
class PTEST_PerDayAdyenFOSalesMen extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE dpm.id=201 AND dd.gender = \"MALE\" AND dt.id >= ".self::$startDate." AND dt.id <= ".self::$endDate." 
                AND dst.id=1 ".
            $whereFilters.
            "GROUP BY dt.id
            ORDER BY dt.id DESC"
        ...
        $this->setName("Adyen €FO Men[[Adyen FO sales - First Order revenue processed by Adyen]]");
    }
