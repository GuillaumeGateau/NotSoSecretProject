...
class PerDayChatUniqueSenders extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        // num_of_unique_senders does not work accross dimensions
        $this->qu1 = "
        SELECT dt.id, SUM(fm.num_of_unique_senders) 
        ...
        $this->setName("Chat Unique Senders[[Chat Unique Senders - Unique users sending messages]]");
    }
