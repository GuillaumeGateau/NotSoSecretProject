...
class PerDayHotseatUnlock extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE fp.dimension_product_id IN (6)
        ...
        $this->setName("Hotseat Unlocks[[Hotseat Unlocks - Total number of Hotseat unlocks]]");
    }
