...
class PerDayPaylineFOSales extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("Payline €FO[[Payline FO sales - First Order revenue processed by Payline]]");
        $this->setGraphName("Payline FO Sales");
        $this->setGraphVar("fo_plin");
        $this->setGraphLabel("Payline €FO");
    }
