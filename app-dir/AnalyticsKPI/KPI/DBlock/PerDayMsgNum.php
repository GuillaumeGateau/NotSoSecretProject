...
class PerDayMsgNum extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("#Msg[[Number of messages - Total number of messages sent]]");
        $this->setGraphName("Messages sent");
        $this->setGraphVar("msg_sent");
        $this->setGraphLabel("#Msg");
    }
