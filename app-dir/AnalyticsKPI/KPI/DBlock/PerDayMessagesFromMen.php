...
class PerDayMessagesFromMen extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("Messages from Men[[Messages from Men - Total number of messages sent by men]]");
    }
