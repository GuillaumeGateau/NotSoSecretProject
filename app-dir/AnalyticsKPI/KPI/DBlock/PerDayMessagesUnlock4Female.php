...
class PerDayMessagesUnlock4Female extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("Women Messages Unlock [[Unlocks for Women - Total number of messages unlocks by users talking to women]]");
    }
