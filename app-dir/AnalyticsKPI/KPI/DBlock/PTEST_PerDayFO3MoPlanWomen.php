...
class PTEST_PerDayFO3MoPlanWomen extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
			...
			WHERE dst.id=1 AND dpt.id=90 AND dl.id IN (22, 74) AND dd.gender = \"FEMALE\" AND dd.age>=40
        ...
        $this->setName("#3MO Women[[3-Month plans - Number of 3-Month plans]]");
        $this->setGraphName("3MO plans");
        $this->setGraphVar("fo_3mo");
        $this->setGraphLabel("#3MO Women");
    }
