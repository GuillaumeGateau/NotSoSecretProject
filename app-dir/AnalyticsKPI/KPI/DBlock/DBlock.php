...
abstract class DBlock {
    ...
    private $graphVar="";
    private $graphName="";
    private $tconversion = boolean;
    private $tdisable = boolean;
    ...
    function setGraphLabel($name) {
        $this->graphLabel = $name;
    }
    ...
    function setGraphVar($name) {
        $this->graphVar = $name;
    }

    function getGraphVar() {
    ...
    function getTConversion() {
        return $this->tconversion;
    }
    
    function setTConversion($tconversion) {
        $this->tconversion = $tconversion;
    }
    
    function getTDisable() {
        return $this->tdisable;
    }
    
    function setTDisable($tdisable) {
