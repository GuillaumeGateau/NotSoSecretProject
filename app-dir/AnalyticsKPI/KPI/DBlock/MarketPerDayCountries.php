...
class MarketPerDayCountries extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            SELECT country_code, country, SUM(num_of_registrations+num_of_registrations_disabled) AS regs FROM fact_registrations AS f
