...
class UsersTrackingWindowShoppers extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE DATEDIFF(DATE(dimension_time_id), DATE(dimension_registered_time_id)) > 3
              ...
              AND (DATEDIFF(DATE(dimension_time_id), DATE(dimension_last_activity_time_id)) > 30 OR dimension_last_activity_time_id = 0)
        ...
        $this->setName("Window Shoppers Users[[Window Shoppers Users - Users who have logged in at least once over the last 30 days, but have sent no messages.
