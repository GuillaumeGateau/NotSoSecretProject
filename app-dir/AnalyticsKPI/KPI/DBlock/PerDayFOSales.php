...
class PerDayFOSales extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE dst.id = 1 AND dimension_payment_method_id NOT IN (211, 212, 213, 214, 215) 
        ...
        $this->setName("€FO[[Sales FO - Revenue generated by First Orders]]");
        $this->setASCIIName("FO_sales");
        $this->setType("float");
        $this->setGraphName("FO Sales");
        $this->setGraphVar("fo_sales");
