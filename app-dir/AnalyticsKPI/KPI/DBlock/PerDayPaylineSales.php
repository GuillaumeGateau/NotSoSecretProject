...
class PerDayPaylineSales extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("€ Payline[[Payline Sales - Successful payments processed through Payline]]");
        $this->setGraphName("Payline Sales");
        $this->setGraphVar("plin_sal");
        $this->setGraphLabel("€ Payline");
    }
