...
class PerDayFilmstripUnlock extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            WHERE fp.dimension_product_id IN (3)
        ...
        $this->setName("Filmstrip Unlocks[[Filmstrip Unlocks - Total number of Filmstrip unlocks]]");
    }
