...
class PerDayPaymentWallRNSales extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("Pay.Wall €RN[[PaymentWall RN sales - Renewal revenue processed by PaymentWal]");
        $this->setGraphName("Pay.Wall RN Sales");
        $this->setGraphVar("rn_pwall");
        $this->setGraphLabel("Pay.Wall €RN");
    }
