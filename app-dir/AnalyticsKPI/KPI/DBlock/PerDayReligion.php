...
class PerDayReligion extends DBlockPerDay{
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->qu1 = "
            ...
            LEFT JOIN (SELECT dt.id AS dates, SUM(fup.num_of_users_with_religion) AS filled
            FROM fact_users_profile AS fup
            LEFT JOIN dimension_time AS dt ON dt.id = fup.dimension_registered_time_id
            LEFT JOIN dimension_location AS dl ON dl.id = fup.dimension_location_id
        ...
        $this->setName("%Religion[[%Religion - % of users registering on this day with Religion completed on date of sign-up]]");
        $this->setType("float");
        $this->setASCIIName("%Religion");
        $this->setGraphName("%Religion");
        $this->setGraphVar("religion");
        $this->setGraphLabel("%ReligionCompleted");
    }
