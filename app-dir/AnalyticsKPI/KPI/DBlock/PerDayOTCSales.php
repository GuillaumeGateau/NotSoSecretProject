...
class PerDayOTCSales extends DBlockPerDay {
    ...
    function __construct(array $filters=null, $limit=null) {
        ...
        $this->setName("€OTC[[OTC Sales - Over The Counter revenue (checks...)]]");
        $this->setGraphName("OTC Sales");
        $this->setGraphVar("otc_sal");
        $this->setGraphLabel("€OTC");
    }
